...
CREATE TABLE chirp_table (
  ...
  PRIMARY KEY(item_id)
   ...
   ("Great Egret", "Heron", "Croak", "Marsh", "Cascasdes"),
   ...
   ("Canvaback", "Waterfowl", "Quack", "Lakes", "Cascades"),
   ...
   ("Barow's Goldeneye", "Waterfowl", "Grunts", "Lakes", "Cascades"),
   ...
   ("Wilsons Phalarope", "Sandpiper", "Wurk", "Ponds", "Northwest"),
   ...
   ("Sand-Tailed Pigeon", "Pigeon and Dove", "Hoo-Hoo", "Forests", "Cascades"),
...
("Hooded Merfanser", "Waterfowl", "Grunts", "Ponds", "Northwest"), 
("Common Merfanser", "Waterfowl", "Silent", "Rivers", "Northewest"),  
